...
Another reason is that mastering a language requires consistent practice. The best practice for learning a language is talking to native speakers in their country (but, as you know, I don’t have the money for that — but I hope I can someday). The second best option is practicing with native speakers online using platforms like Episoden or other language exchange apps, but I’m a little too shy to practice speaking just through my phone, so I haven’t started yet.
